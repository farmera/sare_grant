...
sugarcane farmers. A disadvantage of traditional methods such as planes and satellites is their cost and relatively low resolution. 

![](img/pixel-sizes.png)
###### Figure 5. Relative pixel dimension depending on satellite image source provider.

A key advantage of such methods is their coverage. The goal in aerial imaging is to get as high as possible without
...
these resolutions drop slightly thus RGB alone is higher resolution compared to all bands 
