...
is the ability to fly close to the ground we made an effort to understand the contribution of an improved GSD in our results. 

The resolution of satellite imagery is relevant as these methods demonstrate why other lower-cost method 
are desirable. Aerial imagery generated by satellite or airplane has traditionally been the only available solution to 
sugarcane farmers. A disadvantage of traditional methods such as planes and satellites is their cost and relatively low 
resolution. A key advantage of such methods is their coverage.
...
of between 100 and 200 ft we were confident, in principle, that our GSD was more than adequate. At these heights our GSD using the dual-camera system was from 3-5 sq in or between 0.06-0.17 sq ft per pixel.
