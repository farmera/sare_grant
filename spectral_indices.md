...
An entire section is 412 by 72 pixels in size but here only a portion of the full section is shown. The middle image shows 
more detail and in the right most image individual pixels a visible. where each pixel has a ground resolution of 2.7 
centimeters (~1 square inch). 
