...
In sections to come we go into greater detail about specific low and high end multi-spectral cameras used in this study (with examples 
of each in action). We'll also discuss strategies for managing the larger volumes of image data generated by this sort of workflow.
Finally, we'll consider strategies for interpreting various vegetation indices under changing environmental conditions. 
